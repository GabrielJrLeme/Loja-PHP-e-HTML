									...
									?>
												...
												<li class="hassubs">
													...
													<ul>
														...
														<li><a href="cientes.php">Clientes</a></li>
...
<?php 
	...
	if(isset($_GET['identi'])){
		...
		$identi = htmlentities($_GET['identi']);

		$query=$mysqli->query("select * from produtos where id = '$identi'");
		$tabela=$query->fetch_assoc();


		$nome_prod = $tabela['nome_prod'];
		$valor_prod = $tabela['valor_prod'];
		$estoque_quant = $tabela['estoque_quant'];
		$descricao = $tabela['descricao'];
		$imagem = $tabela['imagem'];
		$promocao = $tabela['promocao'];
			...
			<div class="row details_row">
				...
				<div class="col-lg-6">
					<div class="details_content">
						<div class="details_name"><h1><?php echo "$nome_prod"; ?></h1></div>
						<div class="details_price" style="font-size: 20px; color: black;"><?php echo "R$ $valor_prod"; ?></div>

						<!-- In Stock -->
						<div class="in_stock_container">
							<div class="availability">Estoque:</div>
							<span><?php echo "$estoque_quant"; ?></span>
						</div>
						...
						<div class="product_quantity_container">
							<div class="button cart_button">
								<?php 
									echo "<a href='carrinho.php?idProduto=$identi'>Adicionar</a>";
								 ?>
							</div>
						</div>
					</div>
		...
		<div class="container">
			<div class="row">
				<div class="col text-center">
					<div class="products_title">Aproveite para levar estes</div>
				</div>
			</div>
			<div class="row">
				<div class="col">
					...
					<div class="product_grid">
						...
						<div class="product">
							...
							<div class="product_content">
								<div class="product_title"><a href="detalhes.php">Smart Phone</a></div>
